...
$this->title = $model->id ? 'Редактирование записи в базе данных' : 'Добавление записи в базу данных';
?>
<?php if(!$model->id){ ?>
...
<div id="contact-tabs" class="uk-switcher uk-margin">
	<div>
<?php } ?>
<?php if(!$model->id || $model->type==Blacklist::TYPE_PERSON){ ?>
		<?= Html::beginForm(['db/edit', 'id' => $model->id], 'post', [
		...
		<div class="uk-margin-bottom">
			<?= Html::input('hidden', 'Blacklist[active]', 0) ?>
			<?= Html::checkbox('Blacklist[active]', $model->active, [
				'data-switchery' => true,
		...
		<div class="form-actions clearfix uk-margin-top">
			...
			<a href="<?= Url::to(['db/index', 'filter' => ['type' => Blacklist::TYPE_PERSON]]) ?>" class="md-btn md-btn-default uk-float-right">Выйти без сохранения</a>
		</div>
...
<?php if(!$model->id){ ?>
	...
	<div>
<?php } ?>
<?php if(!$model->id || $model->type==Blacklist::TYPE_ORG){ ?>
		<?= Html::beginForm(['db/edit', 'id' => $model->id], 'post', [
				'enctype' => 'multipart/form-data',
				'class' => 'uk-margin-top form-validation'
		]) ?>
		...
		<div class="form-actions clearfix uk-margin-top">
			<button type="submit" class="md-btn md-btn-primary">Сохранить</button>
			<a href="<?= Url::to(['db/index', 'filter' => ['type' => Blacklist::TYPE_ORG]]) ?>" class="md-btn md-btn-default uk-float-right">Выйти без сохранения</a>
		</div>
